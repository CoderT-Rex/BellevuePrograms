...
public class Module2_jrex {
    ...
    System.out.println("How much water needs to be heated? Kilograms of water: ");
    double waterMass = input.nextDouble();
    
    //Prompt the user for current temperature and desired temperature
    System.out.println("What is the water's current temperature? Temperature in Celsius: ");
    double currentTemp = input.nextDouble();
    System.out.println("What is the desired water temperature Temperature in Celsius: ");
    ...
    //Display the result
    System.out.println("It wil take "+energy+" joules to increase the water temperature by "+adjustedTemp+" degrees." );
    }
}
